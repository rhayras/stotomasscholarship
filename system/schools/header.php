        ...
        <div class="modal-body">
          <form action="" method="POST" id="schoolForm">
            <div class="form-group">
              ...
              <select name="schooltype" id="schooltype" class="form-control" form="schoolForm" required>
                <option></option>
                <option value="0">Public School</option>
                <option value="1">Semi-Private School</option>
                <option value="2">Private School</option>
              </select>
            </div>
            <div class="form-group">
              <label>School Name</label>
              <input type="text" name="schoolname" id="schoolname" class="form-control" form="schoolForm" required>
            </div>
            <div class="form-group">
              <label>School Alias</label>
              <input type="text" name="schoolalias" id="schoolalias" class="form-control" form="schoolForm" required>
            </div>
            <div class="form-group">
              <input type="submit" class="btn btn-success pull-right" name="add" id="submit" value="Submit" form="schoolForm">
            </div>
          </form>
        </div>
