      ...
      <div class="modal-dialog">
          <div class="modal-content">
              ...
              <div class="modal-body">
                <small>Enter the reason to disapprove this Scholarship Renewal Application.</small>
                  <form action="" method="POST" id="reasonform">
                    <div class="form-group">
                      <input type="hidden" name="studentid" form="reasonform" id="student"value="<?php echo $_GET['id']?>">
	...
	<div class="col-md-12 col-lg-12" id="mainContainer">
		<div class="row" style="margin-bottom:-25px;">
			<div class="col-md-4 col-lg-4 col-xs-12 col-sm-12">
				<center>
					...
					<button class="btn btn-success" data-toggle="modal" data-target="#approvemodal">Approve Renewal</button>
					<button class="btn btn-danger" data-toggle="modal" data-target="#declineModal">Disapprove Renewal</button>
				</center>
			</div>
        ...
        <div class="card-header tab-card-header">
          <ul class="nav nav-tabs card-header-tabs" id="myTab" role="tablist">
            <li class="nav-item">
                <a class="nav-link" id="one-tab" data-toggle="tab" href="#one" role="tab" aria-controls="One" aria-selected="true">Renewal Information</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" id="two-tab" data-toggle="tab" href="#two" role="tab" aria-controls="Two" aria-selected="false">Scholarship History</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link" id="four-tab" data-toggle="tab" href="#four" role="tab" aria-controls="Four" aria-selected="false">Requirements</a>
            </li>
          </ul>
        </div>
        ...
        <div class="tab-content" id="myTabContent">
          <div class="tab-pane fade show active p-3" id="one" role="tabpanel" aria-labelledby="one-tab">
                <table class="table-bordered table-striped" style="table-layout: fixed;width: 100%;font-size: 13px;">
                    <tr>
                    	<td>School</td>
                    	<td><?php echo $resultSchool['schoolname']?></td>
                    </tr>
                    <tr>
                    	<td>Student Type</td>
                    	<td><?php echo $resultApplicant['studenttype']?></td>
                    </tr>
                    <tr>
                    	<td>Year / Grade Level</td>
                    	<td><?php echo $resultApplicant['yearOrgrade']?></td>
                    </tr>
                    <tr>
                    	<td>School Year / Semester</td>
                    	<td><?php echo $schyear?> / <?php echo $sem?></td>
                    </tr>
                    <tr>
                    	<td>Previous GWA</td>
                    	<td><?php echo $resultApplicant['gwa']?></td>
                    </tr>
                </table>
                <br>
                <div class="row">
                	<div class="col-md-4 col-lg-4 col-sm-12 col-xs-12">
                		<p>Previous Grade Card</p>
                		<?php
                        ...
                        if($processCheck->num_rows > 0)
                        {
                            ...
                            ?>
                             <a href='../requirements/schoolrequirements/<?php echo $resultCheck['gradecard']?>' target="_blank" style='font-size:13px;'>View Document</a>
                           <iframe src="../requirements/schoolrequirements/<?php echo $resultCheck['gradecard']?>" style='width: 100%;height:200px;'></iframe>
                            <?php
                        }
                        else
                        {
                	...
                	<div class="col-md-4 col-lg-4 col-sm-12 col-xs-12">
                		<p>Previous Registration Form</p>
                		<?php
                        ...
                        if($processCheck->num_rows > 0)
                        {
                            $resultCheck = $processCheck->fetch_assoc();
                            ?>
                             <a href='../requirements/schoolrequirements/<?php echo $resultCheck['regform']?>' target="_blank" style='font-size:13px;margin-top:-20px;'>View Document</a>
                           <iframe src="../requirements/schoolrequirements/<?php echo $resultCheck['regform']?>" style='width: 100%;height:200px;'></iframe>
                            <?php
                        }
                        else
                        {
                	...
                	<div class="col-md-4 col-lg-4 col-sm-12 col-xs-12">
                        ...
                        if($processCheck->num_rows > 0)
                        {
                            $resultCheck = $processCheck->fetch_assoc();
                            ?>
                             <a href='../requirements/schoolrequirements/<?php echo $resultCheck['schoolid']?>' target="_blank" style='font-size:13px;margin-top:-20px;'>View Document</a>
                           <iframe src="../requirements/schoolrequirements/<?php echo $resultCheck['schoolid']?>" style='width: 100%;height:200px;'></iframe>
                            <?php
                        }
                        else
                        {
