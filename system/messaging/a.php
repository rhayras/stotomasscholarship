			...
			<div class="row">
									...
									<div id="individual" class="individual container<?php echo $studentId?>" studentId="<?php echo $studentId?>" studentName = "<?php echo $resultScholars['firstname']." ".$resultScholars['surname']?>">
										<div class="row">
											...
											<div class="col-md-10 col-lg-10 col-xs-8 col-sm-8">
												<p style="line-height:15px;"><?php echo $resultScholars['firstname']." ".$resultScholars['surname']?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="dot" style="background-color: <?php echo $color?>"></span><br >
				...
				<div class="col-md-8 col-lg-8">
					<div class="divContainer" style="overflow-y: hidden;">
	                    ...
	                    <div id="convoAdmin" style="border: 1px solid gainsboro">
	                      <!-- convo here -->
	                    </div>
	                    <form method="POST" id="adminChatForm"></form>
	                    <div class="chat" style="padding: 5px;margin-top: -10px;">
	                        <div class="row">
	                          <div class="col-md-11 col-xs-11">
	                            ...
	                            <textarea cols="40" row="3" name="messageAdmin" id="message" class="form-control" required placeholder = "Type a message..." style="width:790px;margin-left:-20px;border: 1px solid transparent;" form="adminChatForm"></textarea>
	                          </div>
	                          <div class="col-md-1 col-xs-1">
	                          	<button type = "submit" name="sendAdmin" value="SEND" id="send" class="btn myBtn" form="adminChatForm" style="margin-left:5px; min-height: 50px;background-color: white; margin-top: 8px;"><i class="fa fa-paper-plane" aria-hidden="true" style="color: #00C851;font-size: 25px;"></i></button>
	                          </div>
	                        </div>
                         </div>
					</div>
