...
<head>
  ...
  #convoAdmin {
    overflow-y: scroll;width:100%;height:380px;border-top:1px solid gainsboro;border-left:1px solid gainsboro;border-right:1px solid gainsboro;padding:10px;margin-bottom:5px;
    line-height: 1.4em;
  }
  #convoStudent
  {
