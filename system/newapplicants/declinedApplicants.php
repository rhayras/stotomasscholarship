...
<div class="row" style="padding: 10px;">
	<div class="col-md-12 col-lg-12" id="mainContainer">
		<span><h4 style="color:gray;">Disapproved Applications
		...
		<div class="table-responsive">
			<table class="table table-bordered " id="maintable">
				...
				<tbody style="font-size: 13px;">
					...
					$status = "";
					$scholartype = "";
					$getApplicant = "SELECT * FROM tbl_student WHERE status IN (3) AND semester = '".$sem."' AND schoolyear = '".$schyear."' ";
					...
					if($processApplicant->num_rows > 0)
					{
						...
						{	
							...
							"<tr>
								...
								<td style='text-align:center;'>".$resultApplicant['declineReason']."</td>
							</tr>";
