...
$getInfo = "SELECT * FROM tbl_applydate WHERE id = ".$id;
...
?>
  ...
  <div class="form-group">
    	<input type="submit" class="btn btn-success pull-right" name="editApplyDate" id="submit" value="Update" form="editForm">
  </div>
