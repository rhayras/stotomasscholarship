      ...
      <div class="modal-dialog">
          <div class="modal-content">
              <div class="modal-header">
                  <h5 class="modal-title">Update Scholarship Grant</h5>
                  <button type="button" class="close" data-dismiss="modal"><span>&times;</span></button>
              </div>
              <div class="modal-body">
                  <form action="" method="POST" id="grantForm">
                    <div class="form-group">
                    	<input type="hidden" name="studentid" form="grantForm" id="student" value="<?php echo $_GET['id']?>">
                      <input type="text" name="grant" id="grant" form="grantForm" class="form-control" required placeholder="Enter Scholarship Grant" style="text-align: center">
                    </div>
                    <div class="pull-right">
                    	<div class="form-group">
	                      <input type="submit" value="Submit" name="submitGrant" class="btn btn-success" form="grantForm">
	                    </div>
                    </div>
                  </form>
              </div>
		...
		<div class="row" style="margin-bottom:-25px;">
			<div class="col-md-4 col-lg-4 col-xs-12 col-sm-12">
				<center>
					...
					{
						if($resultApplicant['grantprice'] == "")
						{
						?>
							<button class="btn btn-success" data-toggle="modal" data-target="#approvemodal">Update Grant</button>
						<?php
						}
					}
					?>
	             ...
	             <table class=" table-striped table-bordered" style="table-layout: fixed;width: 100%;font-size: 13px;">
	             		...
	             		<tr>
		             		...
		             		<td>
		             			...
		             			{
		             				?>
		             				 &#8369; <?php echo number_format($resultApplicant['grantprice'],2)?>
		             				<?php
		             			}else{?>
