        ...
        <div class="modal-body">
          <form method="POST" id="adduserform">
            <div class="form-group">
              <label>Name</label>
              <input type="text" name="fullname" id="fullname" class="form-control" form="adduserform" required>
            </div>
            <div class="form-group">
              <label>Username</label>
              <input type="text" name="username" id="username" class="form-control" form="adduserform" required>
            </div>
            <div class="form-group">
              <label>Password</label>
              <input type="password" name="password" id="password" class="form-control" form="adduserform" required>
            </div>
            <div class="form-group">
              <label>Priviledge</label>
              <input type="text" name="priviledge" id="priviledge" class="form-control" form="adduserform" readonly value="admin">
            </div>
            <div class="form-group">
              <input type="submit" class="btn btn-success pull-right" name="adduser" id="submit" value="Submit" form="adduserform">
            </div>
          </form>
        </div>
